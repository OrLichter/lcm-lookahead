...
class LCMSingleStepScheduler(SchedulerMixin, ConfigMixin):
    ...
    def step(
        ...
        if self.config.prediction_type == "epsilon":  # noise-prediction
            predicted_original_sample = (sample - beta_prod_t.sqrt()[..., None, None, None] * model_output) / alpha_prod_t.sqrt()[..., None, None, None]
        ...
        denoised = c_out[..., None, None, None] * predicted_original_sample + c_skip[..., None, None, None] * sample
